...
class ContactForce():
    ...
    def forces(self,last_n_frames=None):
        if last_n_frames:
            full_data = np.array(self._forces)
            return full_data[-last_n_frames:,None]
        else:
...
if __name__ == "__main__":
    ...
    contact_force = ContactForce(IP="172.16.0.1") # IP="172.16.0.50")
